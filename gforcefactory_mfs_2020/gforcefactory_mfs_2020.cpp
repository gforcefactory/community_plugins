        ...
        case SIMCONNECT_RECV_ID_SIMOBJECT_DATA_BYTYPE:
        {
            ...
            switch(pObjData->dwRequestID)
            {
                case REQUEST_1:
                {
                    ...
                    printf("acc_x:%0.1f acc_y:%.1f acc_z:%.1f rot_x:%.1f rot_y:%.1f rot_z:%.1f\n", pS->acc_x, pS->acc_y, pS->acc_z, pS->rot_x, pS->rot_y, pS->rot_z );
                    hr = SimConnect_RequestDataOnSimObjectType(hSimConnect, REQUEST_1, DEFINITION_1, 0, SIMCONNECT_SIMOBJECT_TYPE_USER);
                    ...
                    if (is_first_msg) {
                        ...
                        msg.timestamp = (uint32_t)(((uint64_t)(GetCounter())) & 0x1ffffff);
                    }
